...
============================================================
  ...
  Powered by Google Gemini 1.5 Flash (free tier) + Search
============================================================
"""
...
def convert_to_html(subject, raw_text):
    ...
    for line in lines:
        ...
        if re.match(r"^\*\*\d+\.", stripped) or (stripped.startswith("**") and stripped.endswith("**") and len(stripped) > 4):
            if in_list:
...
<title>""" + subject + """</title>
<style>
  body { font-family: Georgia, serif; background-color: #f4f4f0; margin: 0; padding: 20px; color: #1a1a1a; }
  ...
  .header { background: #0a2540; padding: 28px 36px; color: #ffffff; }
  .header h1 { margin: 0; font-size: 22px; font-weight: 700; }
  .header p { margin: 6px 0 0; font-size: 13px; color: #8aa4c8; font-family: Arial, sans-serif; }
  .content { padding: 32px 36px; line-height: 1.75; }
  h2.section-header { font-size: 16px; color: #0a2540; margin: 32px 0 10px; padding: 10px 14px; background: #f0f4fa; border-left: 4px solid #1a73e8; border-radius: 0 4px 4px 0; }
  p { margin: 0 0 14px; font-size: 15px; color: #2d2d2d; }
  ul { padding-left: 20px; margin: 8px 0 16px; }
  li { margin-bottom: 7px; font-size: 15px; color: #2d2d2d; }
  strong { color: #0a2540; }
  hr.divider { border: none; border-top: 1px solid #e8e8e8; margin: 24px 0; }
  .footer { background: #f9f9f7; border-top: 1px solid #e8e8e8; padding: 16px 36px; font-family: Arial, sans-serif; font-size: 12px; color: #888; text-align: center; }
</style>
</head>
<body>
<div class="container">
  ...
  <div class="footer">
    Generated by your market intelligence system &nbsp;|&nbsp; Powered by Google Gemini with live search &nbsp;|&nbsp; Free
  </div>
</div>
</body>
</html>"""
